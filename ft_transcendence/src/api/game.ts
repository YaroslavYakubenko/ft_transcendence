...
export async function getUserStats(_userId: number): Promise<UserStats> {
    return { wins: 12, losses: 4, rank: 3, level: 5, xp: 340, xpToNextLevel: 500 }
  }                                                                                                                                                             
  ...
  export async function getAchievements(_userId: number): Promise<Achievement[]> {
    return [
      ...
      { id: 4, name: "Grandmaster",   description: "Reach level 10",            unlocked: false },                                                              
      { id: 5, name: "Untouchable",   description: "Win 5 games without a loss", unlocked: false },                                                             
    ]                                                                                                                                                           
  }                                                                                                                                                             
                                                                                                                                                                
  export async function getLeaderboard(): Promise<{ id: number; username: string; wins: number; losses: number; level: number; rank: number }[]> {              
    return [
      { id: 1, username: "alice", wins: 42, losses: 5,  level: 12, rank: 1 },                                                                                   
      { id: 2, username: "bob",   wins: 35, losses: 12, level: 10, rank: 2 },                                                                                   
      { id: 3, username: "carol", wins: 28, losses: 8,  level: 8,  rank: 3 },                                                                                   
      { id: 4, username: "dave",  wins: 21, losses: 20, level: 6,  rank: 4 },                                                                                   
      { id: 5, username: "eve",   wins: 15, losses: 30, level: 4,  rank: 5 },                                                                                   
    ]                                                                                                                                                           
  } 